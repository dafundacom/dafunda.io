...
const Card = ({ title, description, imgSrc, href, cta }) => (
    ...
    >
      ...
      <div className="p-6">
        ...
        {cta && (
          <Link
            href={href}
            className="text-base font-medium leading-6 text-primary-500 dark:hover:text-primary-400 hover:text-primary-600"
